...
export function MessageBubble({ message }: { message: Message }) {
  // "me" = patient = RIGHT side (green/outgoing bubble)
  // "them" = bot/doctor = LEFT side (white/incoming bubble)
  const isPatient = message.sender === "me";

  return (
    <div className={cn("flex w-full px-3", isPatient ? "justify-end" : "justify-start")}>
      <div
        className={cn(
